...
function App() {
  ...
  const [showDiv1, setShowDiv1] = useState(true); // Estado para controlar la visibilidad de los divs
  ...
  const handleSubmit = (e) => {
    ...
    setShowDiv1(!showDiv1); // Cambia el estado de visibilidad de los divs
  };
